...
CREATE TABLE Habitacion (
    ...
    FOREIGN KEY (categoria_id) REFERENCES CategoriaHabitacion(categoria_id)
);
...
-- Tabla para almacenar el historial de reservas
CREATE TABLE HistorialReserva(
	historialReservas_id INT PRIMARY KEY AUTO_INCREMENT,
    reserva_id INT,
    FOREIGN KEY (reserva_id) REFERENCES Reserva(reserva_id)
);
...
CREATE TABLE HistorialPrecio (
    historialPrecio_id INT PRIMARY KEY AUTO_INCREMENT,
    habitacion_id INT,
